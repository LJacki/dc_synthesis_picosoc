###############################################################################
# dc_compile_E4.tcl - wire_load_mode: segmented
###############################################################################
...
set OUTPUT_DIR "$PROJ_DIR/03_output_E4"
...
puts "\n========================================"
puts "  DC Synthesis 500MHz - Group E4"
puts "  wire_load_mode: segmented"
puts "========================================"
