###############################################################################
# dc_compile_A.tcl - compile_ultra: -gate_clock -no_autoungroup -timing (baseline)
###############################################################################
...
set OUTPUT_DIR "$PROJ_DIR/03_output_compile_A"
...
puts "\n========================================"
puts "  DC Synthesis 500MHz - Group A (Baseline)"
puts "  compile_ultra -gate_clock -no_autoungroup -timing"
puts "========================================"
...
# --- [2] Analyze ---
puts "\n\[2/8\] Analyzing RTL..."
define_design_lib WORK ./work_lib
