###############################################################################
# dc_compile_D3.tcl - set_max_area 50000 (中等约束)
###############################################################################
...
set OUTPUT_DIR "$PROJ_DIR/03_output_D3"
...
puts "\n========================================"
puts "  DC Synthesis 500MHz - Group D3"
puts "  set_max_area 50000 (中等约束)"
puts "========================================"
