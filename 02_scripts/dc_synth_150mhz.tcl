###############################################################################
# dc_synth_300mhz.tcl - 150MHz DC Synthesis Script
...
set REPORTS   $PROJ_DIR/03_output_150mhz/reports
set NETLIST   $PROJ_DIR/03_output_150mhz/netlist
set OUTPUT    $PROJ_DIR/03_output_150mhz
...
puts ""
puts "========== Reading RTL =========="
# Read RTL - explicit order (picosoc.v has a TCL guard, requires picorv32.v to load first)
set RTL_ORDERED {
    $RTL_DIR/picorv32.v
...
puts ""
puts "========== Override clock period to 150MHz =========="
...
puts ""
puts "=========================================="
puts "  DC 150MHz Synthesis Complete"
puts "  CLK_PERIOD : $CLK_PERIOD ns"
puts "=========================================="
