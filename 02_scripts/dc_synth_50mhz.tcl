###############################################################################
# dc_synth_300mhz.tcl - 50MHz DC Synthesis Script
...
set REPORTS   $PROJ_DIR/03_output_50mhz/reports
set NETLIST   $PROJ_DIR/03_output_50mhz/netlist
set OUTPUT    $PROJ_DIR/03_output_50mhz
...
puts ""
puts "========== Override clock period to 50MHz =========="
...
puts ""
puts "=========================================="
puts "  DC 50MHz Synthesis Complete"
puts "  CLK_PERIOD : $CLK_PERIOD ns"
puts "=========================================="
