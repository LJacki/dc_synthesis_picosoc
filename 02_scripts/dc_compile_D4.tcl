###############################################################################
# dc_compile_D4.tcl - set_max_area 40000 (激进约束)
###############################################################################
...
set OUTPUT_DIR "$PROJ_DIR/03_output_D4"
...
puts "\n========================================"
puts "  DC Synthesis 500MHz - Group D4"
puts "  set_max_area 40000 (激进约束)"
puts "========================================"
