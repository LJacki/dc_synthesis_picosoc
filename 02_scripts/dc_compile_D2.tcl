###############################################################################
# dc_compile_D2.tcl - set_max_area 60000 (宽松约束)
###############################################################################
...
set OUTPUT_DIR "$PROJ_DIR/03_output_D2"
...
puts "\n========================================"
puts "  DC Synthesis 500MHz - Group D2"
puts "  set_max_area 60000 (宽松约束)"
puts "========================================"
