###############################################################################
# dc_compile_E3.tcl - wire_load_mode: enclosed
###############################################################################
...
set OUTPUT_DIR "$PROJ_DIR/03_output_E3"
...
puts "\n========================================"
puts "  DC Synthesis 500MHz - Group E3"
puts "  wire_load_mode: enclosed"
puts "========================================"
