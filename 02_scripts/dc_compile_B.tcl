###############################################################################
# dc_compile_B.tcl - compile_ultra: default auto_ungroup (no -no_autoungroup)
# 对比：去掉 -no_autoungroup，看 DC 默认是否会解组模块
###############################################################################
...
set OUTPUT_DIR "$PROJ_DIR/03_output_compile_B"
...
puts "\n========================================"
puts "  DC Synthesis 500MHz - Group B"
puts "  compile_ultra -gate_clock (default auto_ungroup)"
puts "========================================"
...
# Only set false path if collection is non-empty
...
# --- [7] Compile ---
puts "\n\[7/8\] Compile (default auto_ungroup)..."
# NOTE: -no_autoungroup NOT used here → DC uses default auto_ungroup
compile_ultra -gate_clock -timing
